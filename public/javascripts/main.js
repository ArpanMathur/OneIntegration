!function(t, e, n) {
    ...
    function M(t, e, n, r) {
        ...
        if (e) {
            ...
            if (sr(t))
                for (var s = e.length = 0; s < t.length; s++) i = M(t[s], null, n, r), y(t[s]) && (n.push(t[s]), r.push(i)), e.push(i);
            else {
                var a = e.$$hashKey;
    ...
    function N(t, e) {
        if (sr(t)) {
            ...
            for (n in e = e || {}, t) !Zn.call(t, n) || "$" === n.charAt(0) && "$" === n.charAt(1) || (e[n] = t[n]);
        return e || t
    }
    ...
    function P(t, e) {
        ...
        if (i == typeof e && "object" == i) {
            if (!sr(t)) {
                ...
                for (r in e)
                    if (!i.hasOwnProperty(r) && "$" !== r.charAt(0) && e[r] !== n && !S(e[r])) return !1;
                return !0
            }
            if (!sr(e)) return !1;
    ...
    function ee(t, e, n, r) {
        function i(t) {
            var i, s, a, u, c, l, f = n && t ? [this.filter(t)] : [this],
                h = e;
            if (!r || null != t)
                for (; f.length;)
                    for (i = f.shift(), s = 0, a = i.length; a > s; s++)
                        for (u = Wn(i[s]), h ? u.triggerHandler("$destroy") : h = !h, c = 0, u = (l = u.children()).length; u > c; c++) f.push(Qn(l[c]));
    ...
    function ne(t) {
        ...
        if (w(t)) {
            ...
            t = e;
            var r;
            if (r = mr.exec(n)) t = [t.createElement(r[1])];
            else {
                var i, o = t;
    ...
    function Ce(t, e, r, i) {
        ...
        c.cookies = function (t, e) {
            ...
            if (!t) {
                if (l.cookie !== T)
                    for (T = l.cookie, i = T.split("; "), O = {}, s = 0; s < i.length; s++) o = i[s], a = o.indexOf("="), a > 0 && (t = unescape(o.substring(0, a)), O[t] === n && (O[t] = unescape(o.substring(a + 1))));
                return O
            }
            ...
            function M(t, e, n, r, i) {
                ...
                case 1:
                    ...
                    if (t = t.className, w(t) && "" !== t)
                        for (; o = c.exec(t);) u = Te(o[2]), U(e, u, "C", r, i) && (n[u] = ar(o[3])), t = t.substr(o.index + o[0].length);
                    break;
                case 3:
                    L(e, t.nodeValue);
                    break;
    ...
    function Ue() {
        ...
        this.$get = ["$httpBackend", "$browser", "$cacheFactory", "$rootScope", "$q", "$injector", function (t, e, r, i, l, h) {
            ...
            function $(r, o, a) {
                ...
                function f() {
                    var t = O(p.pendingRequests, r); - 1 !== t && p.pendingRequests.splice(t, 1)
                }
                var h, $, w = l.defer(),
                    b = w.promise,
                    x = d(r.url, r.params);
                    ...
                    try {
                        for (var e, n = 0, s = $; s > n; n++) {
                            if ("function" == typeof (e = p[n]))
                                if (e = e(t), e = c ? i.getTrusted(c, e) : i.valueOf(e), null == e) e = "";
            ...
            l.prototype = {
                ...
                $watchCollection: function (t, e) {
                    ...
                    return this.$watch(function () {
                        ...
                        if (y(n))
                            if (i(n))
                                for (r !== f && (r = f, $ = r.length = 0, c++), t = n.length, $ !== t && (c++, r.length = $ = t), e = 0; t > e; e++) o = r[e] !== r[e] && n[e] !== n[e], o || r[e] === n[e] || (c++, r[e] = n[e]);
                            else {
                                r !== h && (r = h = {}, $ = 0, c++), t = 0;
                                for (e in n) n.hasOwnProperty(e) && (t++, r.hasOwnProperty(e) ? (o = r[e] !== r[e] && n[e] !== n[e], o || r[e] === n[e] || (c++, r[e] = n[e])) : ($++, r[e] = n[e], c++));
                                if ($ > t)
                                    for (e in c++, r) r.hasOwnProperty(e) && !n.hasOwnProperty(e) && ($--, delete r[e])
                            } else r !== n && (r = n, c++);
                        return c
                    }, function () {
                        if (p ? (p = !1, e(n, n, s)) : e(n, o, s), u)
                            if (y(n))
                                if (i(n)) {
                                    ...
                                    for (t in o = {}, n) Zn.call(n, t) && (o[t] = n[t]);
                        else o = n
                    })
                },
                $digest: function () {
                    var r, i, o, a, c, l, h, p, $, g, m = this.$$asyncQueue,
                    ...
                    do {
                        ...
                        t: do {
                            ...
                            if (!(a = h.$$childHead || h !== this && h.$$nextSibling))
                                for (; h !== this && !(a = h.$$nextSibling);) h = h.$parent
                        } while (h = a);
                ...
                $on: function (t, e) {
                    ...
                    var i = this;
                    return function () {
                        var r = O(n, e); - 1 !== r && (n[r] = null, p(i, 1, t))
                    }
                },
                $emit: function (t) {
                    var e, n, r, i = [],
        ...
        return function (t, e, n) {
            ...
            i.check = function (t) {
                ...
                if (t && e && "object" == typeof t && "object" == typeof e) {
                    for (var r in t)
                        if ("$" !== r.charAt(0) && Zn.call(t, r) && n(t[r], e[r])) return !0;
                    return !1
                }
    ...
    function Mn(t, e, n, r, i) {
        ...
        if (c) i > 0 && t > -1 && 1 > t && (a = t.toFixed(i));
        else {
            ...
            var l = 0,
                ...
                h = e.gSize;
            if (s.length >= f + h)
                for (l = s.length - f, c = 0; l > c; c++) 0 === (l - c) % h && 0 !== c && (a += n), a += s.charAt(c);
    ...
    function Fn(t, e, n, r) {
        ...
        s.$name = e.name || e.ngForm, s.$dirty = !1, s.$pristine = !0, s.$valid = !0, s.$invalid = !1, a.$addControl(s), t.addClass(bi), i(!0), s.$addControl = function (t) {
            ...
            var r = c[t];
            if (e) r && (T(r, n), r.length || (u--, u || (i(e), s.$valid = !0, s.$invalid = !1), c[t] = !1, i(!0, t), a.$setValidity(t, !0, s)));
            else {
                if (u || i(e), r) {
                    if (-1 != O(r, n)) return
    ...
    var Bn, Wn, Qn, Gn, Jn, Xn = "validity",
        Kn = function (t) {
    ...
    Ze.prototype = Ke.prototype = Xe.prototype = {
        ...
        search: function (t, e) {
            ...
            case 0:
                return this.$$search;
            case 1:
                if (w(t) || b(t)) t = t.toString(), this.$$search = _(t);
                else {
    ...
    Qr.prototype = {
        ...
        readIdent: function () {
            ...
            if (s = {
                    index: s,
                    text: o
                }, Br.hasOwnProperty(o)) s.fn = Br[o], s.literal = !0, s.constant = !0;
            else {
        ...
        readString: function (t) {
            ...
            for (var n = "", r = t, i = !1; this.index < this.text.length;) {
                var o = this.text.charAt(this.index),
                    r = r + o;
                if (i) "u" === o ? (i = this.text.substring(this.index + 1, this.index + 5), i.match(/[\da-f]{4}/i) || this.throwError("Invalid unicode escape [\\u" + i + "]"), this.index += 4, n += String.fromCharCode(parseInt(i, 16))) : n += Wr[o] || o, i = !1;
                else if ("\\" === o) i = !0;
                else {
                ...
                link: function (r, a, u, c, l) {
                    ...
                    r.$watchCollection(c, function (t) {
                        ...
                        for (m = C.length, c = O.length = C.length, u = 0; c > u; u++)
                            if (b = t === C ? u : C[u], x = t[b], f = S(b, x, u), J(f, "`track by` id"), w.hasOwnProperty(f)) k = w[f], delete w[f], E[f] = k, O[u] = k;
                            else {
                        ...
                        function u() {
                            ...
                            if (A = {}, E = !1, v)
                                if (n = a.$modelValue, S && sr(n))
                                    for (E = new ye([]), t = {}, u = 0; u < n.length; u++) t[f] = n[u], E.put(S(e, t), n[u]);
                                else E = new ye(n);
                            u = E;
                            var T, M;
            ...
            return {
                ...
                compile: function () {
                    ...
                    return function (t, n, a) {
                        ...
                        var $, y, w, k = angular.isDefined(m.appendToBody) ? m.appendToBody : !1,
                            x = g(void 0),
...
! function (o, n, e) {
    ...
    n.module("ngCookies", ["ng"]).factory("$cookies", ["$rootScope", "$browser", function (o, i) {
        ...
        return i.addPollFn(function () {
            ...
            if (f)
                for (o in t = i.cookies(), r) r[o] !== t[o] && (s(t[o]) ? delete r[o] : r[o] = t[o])
        }), r
            ...
            function y(e, i, a, u, p, v, $) {
                ...
                return E.locals = {
                    ...
                    var O = t.path,
                        ...
                        V = [];
                    if (!a.reload)
                        for (; C && C === h[q] && C.ownParams.$$equals(r, p);) k = V[q] = C.locals, q++, C = O[q];
